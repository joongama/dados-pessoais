...
public class Pessoa {
    ...
    // ATENÇÃO 1: gere os getters e setters de todos os campos acima. // Na IDE:
    // botão direito na classe Generate Getter and Setter // =======

    // ATENÇÃO 2: NOTAR QUE SÃO 2 CONSTRUTORES (0 "padrão" sem argumentos // e o que
    // recebe todas as propriedades como argumentos)
    // ========
    public Pessoa() {
    }
